...
import { OMNIDEF } from './cSAHousingTransferRequestsEnglish_def.js';
import tmpl from './cSAHousingTransferRequestsEnglish.html';
import tmpl_nds from './cSAHousingTransferRequestsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cSAHousingTransferRequestsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
