...
import { OMNIDEF } from './homelessnessIntakeEnglish_def.js';
import tmpl from './homelessnessIntakeEnglish.html';
import tmpl_nds from './homelessnessIntakeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class homelessnessIntakeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
