...
import { OMNIDEF } from './placementHomelessnessEnglish_def.js';
import tmpl from './placementHomelessnessEnglish.html';
import tmpl_nds from './placementHomelessnessEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placementHomelessnessEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
