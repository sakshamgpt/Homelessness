...
import { OMNIDEF } from './housingInstructionEnglish_def.js';
import tmpl from './housingInstructionEnglish.html';
import tmpl_nds from './housingInstructionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class housingInstructionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
