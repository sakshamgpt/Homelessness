...
import { OMNIDEF } from './householdHouseholdEnglish_def.js';
import tmpl from './householdHouseholdEnglish.html';
import tmpl_nds from './householdHouseholdEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class householdHouseholdEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
