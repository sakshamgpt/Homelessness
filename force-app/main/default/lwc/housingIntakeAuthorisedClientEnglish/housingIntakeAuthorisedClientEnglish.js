...
import { OMNIDEF } from './housingIntakeAuthorisedClientEnglish_def.js';
import tmpl from './housingIntakeAuthorisedClientEnglish.html';
import tmpl_nds from './housingIntakeAuthorisedClientEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class housingIntakeAuthorisedClientEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
