...
import { OMNIDEF } from './homelessnessDetailEnglish_def.js';
import tmpl from './homelessnessDetailEnglish.html';
import tmpl_nds from './homelessnessDetailEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class homelessnessDetailEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
