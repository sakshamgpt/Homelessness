...
import { OMNIDEF } from './housingAssignProgramsEnglish_def.js';
import tmpl from './housingAssignProgramsEnglish.html';
import tmpl_nds from './housingAssignProgramsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class housingAssignProgramsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
