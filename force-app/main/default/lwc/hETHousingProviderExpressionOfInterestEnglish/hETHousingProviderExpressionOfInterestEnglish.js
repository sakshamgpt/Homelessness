...
import { OMNIDEF } from './hETHousingProviderExpressionOfInterestEnglish_def.js';
import tmpl from './hETHousingProviderExpressionOfInterestEnglish.html';
import tmpl_nds from './hETHousingProviderExpressionOfInterestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class hETHousingProviderExpressionOfInterestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
