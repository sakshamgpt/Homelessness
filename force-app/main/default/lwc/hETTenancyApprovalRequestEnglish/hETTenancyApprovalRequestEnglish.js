...
import { OMNIDEF } from './hETTenancyApprovalRequestEnglish_def.js';
import tmpl from './hETTenancyApprovalRequestEnglish.html';
import tmpl_nds from './hETTenancyApprovalRequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class hETTenancyApprovalRequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
